...
## 4.8.20 version<a id='4.8.20'></a>

## Table of Contents
* [What's New](#4.8.20-what-is-new)
* [Recommendations for use](#4.8.20-recommendations)
* [Installation](#4.8.20-installation)
* [UIKit](#4.8.20-uikit)
    * [Usage](#4.8.20-uikit-usage)
    * [Offline mode](#4.8.20-uikit-offline)
    * [Settings сlass](#4.8.20-uikit-settings-class)
    * [Functions](#4.8.20-uikit-functions)
    * [Events](#4.8.20-uikit-events)
    * [Festivals](#4.8.20-uikit-fest)
* [SwiftUI](#4.8.20-swiftui)
    * [Usage](#4.8.20-swiftui-usage)
    * [Offline mode](#4.8.20-swiftui-offline)
    * [Settings сlass](#4.8.20-swiftui-settings-class)
    * [Functions](#4.8.20-swiftui-functions)
    * [Events](#4.8.20-swiftui-events)
    * [Festivals](#4.8.20-swiftui-fest)
* [Navigation](#4.8.20-navigation)
* [GlobalLocationProvider](#4.8.20-global-location-provider)
* [CrowdConnected location provider](#4.8.20-cc-navigation)
* [IndoorAtlas location provider](#4.8.20-ia-navigation)

## What's New in ExpoFP Fplan version 4.8.20<a id='4.8.20-what-is-new'></a>

Dependency on CrowdConnected SDK 1.6.7 for SPM and 1.6.6 for CocoaPods is specified

## Recommendations for use<a id='4.8.20-recommendations'></a>
...
## Offline mode<a id='4.8.20-uikit-offline'></a>
...
## Settings сlass<a id='4.8.20-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.8.20-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.8.20-global-location-provider) should be used.
...
## Functions<a id='4.8.20-uikit-functions'></a>
...
## Events<a id='4.8.20-uikit-events'></a>
...
## Festivals<a id='4.8.20-uikit-fest'></a>
...
## Offline mode<a id='4.8.20-swiftui-offline'></a>
...
## Settings сlass<a id='4.8.20-swiftui-settings-class'></a>
...
## Functions<a id='4.8.20-swiftui-functions'></a>
...
## Events<a id='4.8.20-swiftui-events'></a>
...
## Festivals<a id='4.8.20-swiftui-fest'></a>
...
## Navigation<a id='4.8.20-navigation'></a>
...
## GlobalLocationProvider<a id='4.8.20-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.8.20-cc-navigation'></a>
...
```swift
pod 'ExpoFpCrowdConnected', '4.8.20'
```
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.8.20-global-location-provider).
...
## IndoorAtlas location provider<a id='4.8.20-ia-navigation'></a>
