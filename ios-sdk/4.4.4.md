...
## 4.4.4 version<a id='4.4.4'></a>

## Table of Contents
* [What's New](#4.4.4-what-is-new)
* [Installation](#4.4.4-installation)
* [UIKit](#4.4.4-uikit)
    * [Usage](#4.4.4-uikit-usage)
    * [Offline mode](#4.4.4-uikit-offline)
    * [Settings сlass](#4.4.4-uikit-settings-class)
    * [Functions](#4.4.4-uikit-functions)
    * [Events](#4.4.4-uikit-events)
    * [Festivals](#4.4.4-uikit-fest)
* [SwiftUI](#4.4.4-swiftui)
    * [Usage](#4.4.4-swiftui-usage)
    * [Offline mode](#4.4.4-swiftui-offline)
    * [Settings сlass](#4.4.4-swiftui-settings-class)
    * [Functions](#4.4.4-swiftui-functions)
    * [Events](#4.4.4-swiftui-events)
    * [Festivals](#4.4.4-swiftui-fest)
* [Navigation](#4.4.4-navigation)
* [GlobalLocationProvider](#4.4.4-global-location-provider)
* [CrowdConnected location provider](#4.4.4-cc-navigation)
* [IndoorAtlas location provider](#4.4.4-ia-navigation)

## What's New in ExpoFP Fplan version 4.4.4<a id='4.4.4-what-is-new'></a>

Privacy manifest file was updated.

## Installation<a id='4.4.4-installation'></a>

Cocoapods:

```swift
pod 'ExpoFpFplan', '4.4.4'
```

SPM: <https://github.com/expofp/expofp-fplan-ios-spm>

# UIKit<a id='4.4.4-uikit'></a>

This documentation block describes all the features and functions of ExpoFP SDK for the UIKit platform.

## Usage<a id='4.4.4-uikit-usage'></a>
...
## Offline mode<a id='4.4.4-uikit-offline'></a>
...
## Settings сlass<a id='4.4.4-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.4.4-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.4.4-global-location-provider) should be used.
...
## Functions<a id='4.4.4-uikit-functions'></a>
...
## Events<a id='4.4.4-uikit-events'></a>
...
## Festivals<a id='4.4.4-uikit-fest'></a>
...
## Offline mode<a id='4.4.4-swiftui-offline'></a>
...
## Settings сlass<a id='4.4.4-swiftui-settings-class'></a>
...
## Functions<a id='4.4.4-swiftui-functions'></a>
...
## Events<a id='4.4.4-swiftui-events'></a>
...
## Festivals<a id='4.4.4-swiftui-fest'></a>
...
## Navigation<a id='4.4.4-navigation'></a>
...
## GlobalLocationProvider<a id='4.4.4-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.4.4-cc-navigation'></a>
...
```swift
pod 'ExpoFpCrowdConnected', '4.4.4'
```
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.4.4-global-location-provider).
...
## IndoorAtlas location provider<a id='4.4.4-ia-navigation'></a>
