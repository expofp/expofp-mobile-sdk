...
parent: iOS SDK
---
## 4.2.0 version<a id='4.2.0'></a>

## Table of Contents
* [What's New](#4.2.0-what-is-new)
* [Installation](#4.2.0-installation)
* [UIKit](#4.2.0-uikit)
    * [Usage](#4.2.0-uikit-usage)
    * [Offline mode](#4.2.0-uikit-offline)
    * [Functions](#4.2.0-uikit-functions)
    * [Events](#4.2.0-uikit-events)
    * [Festivals](#4.2.0-uikit-fest)
* [SwiftUI](#4.2.0-swiftui)
    * [Usage](#4.2.0-swiftui-usage)
    * [Offline mode](#4.2.0-swiftui-offline)
    * [Functions](#4.2.0-swiftui-functions)
    * [Events](#4.2.0-swiftui-events)
    * [Festivals](#4.2.0-swiftui-fest)
* [Navigation](#4.2.0-navigation)
* [GlobalLocationProvider](#4.2.0-global-location-provider)
* [CrowdConnected location provider](#4.2.0-cc-navigation)
* [IndoorAtlas location provider](#4.2.0-ia-navigation)
* [ExpoFP-GPS location provider](#4.2.0-efp-navigation)

## What's New in ExpoFP Fplan version 4.2.0<a id='4.2.0-what-is-new'></a>

Integration with Festivals has been added.

## Installation<a id='4.2.0-installation'></a>
...
## UIKit<a id='4.2.0-uikit'></a>

### Usage<a id='4.2.0-uikit-usage'></a>
...
### Offline mode<a id='4.2.0-uikit-offline'></a>
...
### Functions<a id='4.2.0-uikit-functions'></a>
...
### Events<a id='4.2.0-uikit-events'></a>
...
### Festivals<a id='4.2.0-uikit-fest'></a>
...
## SwiftUI<a id='4.2.0-swiftui'></a>

### Usage<a id='4.2.0-swiftui-usage'></a>
...
### Offline mode<a id='4.2.0-swiftui-offline'></a>
...
### Functions<a id='4.2.0-swiftui-functions'></a>
...
fplanView.clear()
```
### Events<a id='4.2.0-swiftui-events'></a>
...
### Festivals<a id='4.2.0-swiftui-fest'></a>
...
struct FplanApp: App {
    ...
    var body: some Scene {
        WindowGroup {
            ...
            {
                fplanView
				.onFestDirectionsClick { id, url in
                    print("[OnFestDirectionsClick] id: \(id); url: \(url)")
                }
                .onAppear {
                    fplanView.load("https://demo.expofp.com")
...
### Navigation<a id='4.2.0-navigation'></a>
...
### GlobalLocationProvider<a id='4.2.0-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.2.0-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.2.0-global-location-provider).
...
## IndoorAtlas location provider<a id='4.2.0-ia-navigation'></a>
...
## ExpoFP-GPS location provider<a id='4.2.0-efp-navigation'></a>
