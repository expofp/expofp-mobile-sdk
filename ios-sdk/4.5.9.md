...
## 4.5.9 version<a id='4.5.9'></a>

## Table of Contents
* [What's New](#4.5.9-what-is-new)
* [Installation](#4.5.9-installation)
* [UIKit](#4.5.9-uikit)
    * [Usage](#4.5.9-uikit-usage)
    * [Offline mode](#4.5.9-uikit-offline)
    * [Settings сlass](#4.5.9-uikit-settings-class)
    * [Functions](#4.5.9-uikit-functions)
    * [Events](#4.5.9-uikit-events)
    * [Festivals](#4.5.9-uikit-fest)
* [SwiftUI](#4.5.9-swiftui)
    * [Usage](#4.5.9-swiftui-usage)
    * [Offline mode](#4.5.9-swiftui-offline)
    * [Settings сlass](#4.5.9-swiftui-settings-class)
    * [Functions](#4.5.9-swiftui-functions)
    * [Events](#4.5.9-swiftui-events)
    * [Festivals](#4.5.9-swiftui-fest)
* [Navigation](#4.5.9-navigation)
* [GlobalLocationProvider](#4.5.9-global-location-provider)
* [CrowdConnected location provider](#4.5.9-cc-navigation)
* [IndoorAtlas location provider](#4.5.9-ia-navigation)

## What's New in ExpoFP Fplan version 4.5.9<a id='4.5.9-what-is-new'></a>

The ability to specify GPS coordinates in the selectRoute method has been added.

## Installation<a id='4.5.9-installation'></a>
...
## Offline mode<a id='4.5.9-uikit-offline'></a>
...
## Settings сlass<a id='4.5.9-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.5.9-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.5.9-global-location-provider) should be used.
...
## Functions<a id='4.5.9-uikit-functions'></a>
...
## Events<a id='4.5.9-uikit-events'></a>
...
## Festivals<a id='4.5.9-uikit-fest'></a>
...
## Offline mode<a id='4.5.9-swiftui-offline'></a>
...
## Settings сlass<a id='4.5.9-swiftui-settings-class'></a>
...
## Functions<a id='4.5.9-swiftui-functions'></a>
...
## Events<a id='4.5.9-swiftui-events'></a>
...
## Festivals<a id='4.5.9-swiftui-fest'></a>
...
## Navigation<a id='4.5.9-navigation'></a>
...
## GlobalLocationProvider<a id='4.5.9-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.5.9-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.5.9-global-location-provider).
...
## IndoorAtlas location provider<a id='4.5.9-ia-navigation'></a>
