...
## 4.9.1 version<a id='4.9.1'></a>

## Table of Contents
* [What's New](#4.9.1-what-is-new)
* [Recommendations for use](#4.9.1-recommendations)
* [Installation](#4.9.1-installation)
* [UIKit](#4.9.1-uikit)
    * [Usage](#4.9.1-uikit-usage)
    * [Offline mode](#4.9.1-uikit-offline)
    * [Settings сlass](#4.9.1-uikit-settings-class)
    * [Functions](#4.9.1-uikit-functions)
    * [Events](#4.9.1-uikit-events)
    * [Festivals](#4.9.1-uikit-fest)
* [SwiftUI](#4.9.1-swiftui)
    * [Usage](#4.9.1-swiftui-usage)
    * [Offline mode](#4.9.1-swiftui-offline)
    * [Settings сlass](#4.9.1-swiftui-settings-class)
    * [Functions](#4.9.1-swiftui-functions)
    * [Events](#4.9.1-swiftui-events)
    * [Festivals](#4.9.1-swiftui-fest)
* [Navigation](#4.9.1-navigation)
* [GlobalLocationProvider](#4.9.1-global-location-provider)
* [CrowdConnected location provider](#4.9.1-cc-navigation)
* [IndoorAtlas location provider](#4.9.1-ia-navigation)

## What's New in ExpoFP Fplan version 4.9.1<a id='4.9.1-what-is-new'></a>

This version of SDK specifies dependencies on CrowdConnected SDK 1.6.7 for CocoaPods and SPM

## Recommendations for use<a id='4.9.1-recommendations'></a>
...
## Offline mode<a id='4.9.1-uikit-offline'></a>
...
## Settings сlass<a id='4.9.1-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.9.1-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.9.1-global-location-provider) should be used.
...
## Functions<a id='4.9.1-uikit-functions'></a>
...
## Events<a id='4.9.1-uikit-events'></a>
...
## Festivals<a id='4.9.1-uikit-fest'></a>
...
## Offline mode<a id='4.9.1-swiftui-offline'></a>
...
## Settings сlass<a id='4.9.1-swiftui-settings-class'></a>
...
## Functions<a id='4.9.1-swiftui-functions'></a>
...
## Events<a id='4.9.1-swiftui-events'></a>
...
## Festivals<a id='4.9.1-swiftui-fest'></a>
...
## Navigation<a id='4.9.1-navigation'></a>
...
## GlobalLocationProvider<a id='4.9.1-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.9.1-cc-navigation'></a>
...
```swift
pod 'ExpoFpCrowdConnected', '4.9.1'
```
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.9.1-global-location-provider).
...
## IndoorAtlas location provider<a id='4.9.1-ia-navigation'></a>
