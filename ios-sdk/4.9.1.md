...
### 1. Downloading a plan into cache directory. The 'downloadZipToCache' method allows to download an offline version of the plan into cache.
...
### 2. Downloading several plans into cache directory.
