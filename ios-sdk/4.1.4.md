...
parent: iOS SDK
---
## 4.1.4 version<a id='4.1.4'></a>

## Table of Contents
* [What's New](#4.1.4-what-is-new)
* [Installation](#4.1.4-installation)
* [UIKit](#4.1.4-uikit)
    * [Usage](#4.1.4-uikit-usage)
    * [Offline mode](#4.1.4-uikit-offline)
    * [Functions](#4.1.4-uikit-functions)
    * [Events](#4.1.4-uikit-events)
* [SwiftUI](#4.1.4-swiftui)
    * [Usage](#4.1.4-swiftui-usage)
    * [Offline mode](#4.1.4-swiftui-offline)
    * [Functions](#4.1.4-swiftui-functions)
    * [Events](#4.1.4-swiftui-events)
* [Navigation](#4.1.4-navigation)
* [GlobalLocationProvider](#4.1.4-global-location-provider)
* [CrowdConnected location provider](#4.1.4-cc-navigation)
* [IndoorAtlas location provider](#4.1.4-ia-navigation)
* [ExpoFP-GPS location provider](#4.1.4-efp-navigation)

## What's New in ExpoFP Fplan version 4.1.4<a id='4.1.4-what-is-new'></a>

Bugs have been fixed.

## Installation<a id='4.1.4-installation'></a>
...
## UIKit<a id='4.1.4-uikit'></a>

### Usage<a id='4.1.4-uikit-usage'></a>
...
### Offline mode<a id='4.1.4-uikit-offline'></a>
...
### Functions<a id='4.1.4-uikit-functions'></a>
...
### Events<a id='4.1.4-uikit-events'></a>
...
## SwiftUI<a id='4.1.4-swiftui'></a>

### Usage<a id='4.1.4-swiftui-usage'></a>
...
### Offline mode<a id='4.1.4-swiftui-offline'></a>
...
### Functions<a id='4.1.4-swiftui-functions'></a>
...
fplanView.clear()
```
### Events<a id='4.1.4-swiftui-events'></a>
...
### Navigation<a id='4.1.4-navigation'></a>
...
### GlobalLocationProvider<a id='4.1.4-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.1.4-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.1.4-global-location-provider).
...
## IndoorAtlas location provider<a id='4.1.4-ia-navigation'></a>
...
## ExpoFP-GPS location provider<a id='4.1.4-efp-navigation'></a>
