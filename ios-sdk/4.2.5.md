...
## 4.2.5 version<a id='4.2.5'></a>

## Table of Contents
* [What's New](#4.2.5-what-is-new)
* [Installation](#4.2.5-installation)
* [UIKit](#4.2.5-uikit)
    * [Usage](#4.2.5-uikit-usage)
    * [Offline mode](#4.2.5-uikit-offline)
    * [Settings сlass](#4.2.5-uikit-settings-class)
    * [Functions](#4.2.5-uikit-functions)
    * [Events](#4.2.5-uikit-events)
    * [Festivals](#4.2.5-uikit-fest)
* [SwiftUI](#4.2.5-swiftui)
    * [Usage](#4.2.5-swiftui-usage)
    * [Offline mode](#4.2.5-swiftui-offline)
    * [Settings сlass](#4.2.5-swiftui-settings-class)
    * [Functions](#4.2.5-swiftui-functions)
    * [Events](#4.2.5-swiftui-events)
    * [Festivals](#4.2.5-swiftui-fest)
* [Navigation](#4.2.5-navigation)
* [GlobalLocationProvider](#4.2.5-global-location-provider)
* [CrowdConnected location provider](#4.2.5-cc-navigation)
* [IndoorAtlas location provider](#4.2.5-ia-navigation)
* [ExpoFP-GPS location provider](#4.2.5-efp-navigation)

## What's New in ExpoFP Fplan version 4.2.5<a id='4.2.5-what-is-new'></a>

Fixed bug in ExpoFpCrowdConnected package.

## Installation<a id='4.2.5-installation'></a>

Cocoapods:

```swift
pod 'ExpoFpFplan', '4.2.5'
```

# UIKit<a id='4.2.5-uikit'></a>

This documentation block describes all the features and functions of ExpoFP SDK for the UIKit platform.

## Usage<a id='4.2.5-uikit-usage'></a>
...
## Offline mode<a id='4.2.5-uikit-offline'></a>
...
## Settings сlass<a id='4.2.5-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.2.5-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.2.5-global-location-provider) should be used.
...
## Functions<a id='4.2.5-uikit-functions'></a>
...
## Events<a id='4.2.5-uikit-events'></a>
...
## Festivals<a id='4.2.5-uikit-fest'></a>
...
## Offline mode<a id='4.2.5-swiftui-offline'></a>
...
## Settings сlass<a id='4.2.5-swiftui-settings-class'></a>
...
## Functions<a id='4.2.5-swiftui-functions'></a>
...
fplanView.clear()
```
## Events<a id='4.2.5-swiftui-events'></a>
...
## Festivals<a id='4.2.5-swiftui-fest'></a>
...
## Navigation<a id='4.2.5-navigation'></a>
...
## GlobalLocationProvider<a id='4.2.5-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.2.5-cc-navigation'></a>
...
```swift
pod 'ExpoFpCrowdConnected', '4.2.5'
```
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.2.5-global-location-provider).
...
## IndoorAtlas location provider<a id='4.2.5-ia-navigation'></a>
...
## ExpoFP-GPS location provider<a id='4.2.5-efp-navigation'></a>
