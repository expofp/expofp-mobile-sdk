...
## 4.5.3 version<a id='4.5.3'></a>

## Table of Contents
* [What's New](#4.5.3-what-is-new)
* [Installation](#4.5.3-installation)
* [UIKit](#4.5.3-uikit)
    * [Usage](#4.5.3-uikit-usage)
    * [Offline mode](#4.5.3-uikit-offline)
    * [Settings сlass](#4.5.3-uikit-settings-class)
    * [Functions](#4.5.3-uikit-functions)
    * [Events](#4.5.3-uikit-events)
    * [Festivals](#4.5.3-uikit-fest)
* [SwiftUI](#4.5.3-swiftui)
    * [Usage](#4.5.3-swiftui-usage)
    * [Offline mode](#4.5.3-swiftui-offline)
    * [Settings сlass](#4.5.3-swiftui-settings-class)
    * [Functions](#4.5.3-swiftui-functions)
    * [Events](#4.5.3-swiftui-events)
    * [Festivals](#4.5.3-swiftui-fest)
* [Navigation](#4.5.3-navigation)
* [GlobalLocationProvider](#4.5.3-global-location-provider)
* [CrowdConnected location provider](#4.5.3-cc-navigation)
* [IndoorAtlas location provider](#4.5.3-ia-navigation)

## What's New in ExpoFP Fplan version 4.5.3<a id='4.5.3-what-is-new'></a>

Added the ability to pass a nil value to the 'selectCategory' method.

## Installation<a id='4.5.3-installation'></a>

Cocoapods:

```swift
pod 'ExpoFpFplan', '4.5.3'
```

SPM: <https://github.com/expofp/expofp-fplan-ios-spm>

# UIKit<a id='4.5.3-uikit'></a>

This documentation block describes all the features and functions of ExpoFP SDK for the UIKit platform.

## Usage<a id='4.5.3-uikit-usage'></a>
...
## Offline mode<a id='4.5.3-uikit-offline'></a>
...
## Settings сlass<a id='4.5.3-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.5.3-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.5.3-global-location-provider) should be used.
...
## Functions<a id='4.5.3-uikit-functions'></a>
...
## Events<a id='4.5.3-uikit-events'></a>
...
## Festivals<a id='4.5.3-uikit-fest'></a>
...
## Offline mode<a id='4.5.3-swiftui-offline'></a>
...
## Settings сlass<a id='4.5.3-swiftui-settings-class'></a>
...
## Functions<a id='4.5.3-swiftui-functions'></a>
...
## Events<a id='4.5.3-swiftui-events'></a>
...
## Festivals<a id='4.5.3-swiftui-fest'></a>
...
## Navigation<a id='4.5.3-navigation'></a>
...
## GlobalLocationProvider<a id='4.5.3-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.5.3-cc-navigation'></a>
...
```swift
pod 'ExpoFpCrowdConnected', '4.5.3'
```
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.5.3-global-location-provider).
...
## IndoorAtlas location provider<a id='4.5.3-ia-navigation'></a>
