...
## 4.8.2 version<a id='4.8.2'></a>

## Table of Contents
* [What's New](#4.8.2-what-is-new)
* [Installation](#4.8.2-installation)
* [UIKit](#4.8.2-uikit)
    * [Usage](#4.8.2-uikit-usage)
    * [Offline mode](#4.8.2-uikit-offline)
    * [Settings сlass](#4.8.2-uikit-settings-class)
    * [Functions](#4.8.2-uikit-functions)
    * [Events](#4.8.2-uikit-events)
    * [Festivals](#4.8.2-uikit-fest)
* [SwiftUI](#4.8.2-swiftui)
    * [Usage](#4.8.2-swiftui-usage)
    * [Offline mode](#4.8.2-swiftui-offline)
    * [Settings сlass](#4.8.2-swiftui-settings-class)
    * [Functions](#4.8.2-swiftui-functions)
    * [Events](#4.8.2-swiftui-events)
    * [Festivals](#4.8.2-swiftui-fest)
* [Navigation](#4.8.2-navigation)
* [GlobalLocationProvider](#4.8.2-global-location-provider)
* [CrowdConnected location provider](#4.8.2-cc-navigation)
* [IndoorAtlas location provider](#4.8.2-ia-navigation)

## What's New in ExpoFP Fplan version 4.8.2<a id='4.8.2-what-is-new'></a>

Added new features and events, updated packages from CrowdConnected to version 2.1.1.

## Installation<a id='4.8.2-installation'></a>
...
## Offline mode<a id='4.8.2-uikit-offline'></a>
...
## Settings сlass<a id='4.8.2-uikit-settings-class'></a>

The Settings class contains all the parameters necessary for the initialization and operation of the plan.

### Parameters passed to the constructor

- locationProvider(LocationProvider, optional) - [location provider](#4.8.2-navigation). The default value for this parameter is nil.

```swift
fplanUiView.load("https://demo.expofp.com/", settings: Settings(locationProvider: GpsProvider()))
```

- useGlobalLocationProvider(boolean) - a parameter indicating that the [global location provider](#4.8.2-global-location-provider) should be used.
...
## Functions<a id='4.8.2-uikit-functions'></a>
...
## Events<a id='4.8.2-uikit-events'></a>
...
## Festivals<a id='4.8.2-uikit-fest'></a>
...
## Offline mode<a id='4.8.2-swiftui-offline'></a>
...
## Settings сlass<a id='4.8.2-swiftui-settings-class'></a>
...
## Functions<a id='4.8.2-swiftui-functions'></a>
...
## Events<a id='4.8.2-swiftui-events'></a>
...
## Festivals<a id='4.8.2-swiftui-fest'></a>
...
## Navigation<a id='4.8.2-navigation'></a>
...
## GlobalLocationProvider<a id='4.8.2-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.8.2-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.8.2-global-location-provider).
...
## IndoorAtlas location provider<a id='4.8.2-ia-navigation'></a>
