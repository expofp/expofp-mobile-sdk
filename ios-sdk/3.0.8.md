...
parent: iOS SDK
---
## 3.0.8 version<a id='3.0.8'></a>

## Table of Contents
* [What's New](#3.0.8-what-is-new)
* [Installation](#3.0.8-installation)
* [Usage](#3.0.8-usage)
* [Functions](#3.0.8-functions)
* [Events](#3.0.8-events)
* [Navigation](#3.0.8-navigation)
* [CrowdConnected location provider](#3.0.8-cc-navigation)
* [IndoorAtlas location provider](#3.0.8-ia-navigation)
* [ExpoFP-GPS location provider](#3.0.8-efp-navigation)

### What's New in ExpoFP Fplan version 3.0.8<a id='3.0.8-what-is-new'></a>

Improved performance and fixed bugs.

### Installation<a id='3.0.8-installation'></a>
...
### Functions<a id='3.0.8-functions'></a>
...
### Navigation<a id='3.0.8-navigation'></a>
...
### CrowdConnected location provider<a id='3.0.8-cc-navigation'></a>
...
### IndoorAtlas location provider<a id='3.0.8-ia-navigation'></a>
...
### ExpoFP-GPS location provider<a id='3.0.8-efp-navigation'></a>
