...
* [Navigation](#4.1.1-navigation)
* [GlobalLocationProvider](#4.1.1-global-location-provider)
...
### Navigation<a id='4.1.1-navigation'></a>
...
### GlobalLocationProvider<a id='4.1.1-global-location-provider'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.1.1-global-location-provider).
