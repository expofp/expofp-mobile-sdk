...
* [Setup](#4.2.0-setup)
* [Usage](#4.2.0-usage)
* [Offline mode](#4.2.0-offline)
* [Functions](#4.2.0-functions)
* [Events](#4.2.0-events)
* [Festivals](#4.2.0-fest)
...
```java
dependencies {
    implementation 'com.expofp:common:4.2.0'
    implementation 'com.expofp:fplan:4.2.0'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.2.0'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.2.0'
...
## Offline mode<a id='4.2.0-offline'></a>
...
## Functions<a id='4.2.0-functions'></a>
...
```java
dependencies {
    implementation 'com.expofp:gpsprovider:4.2.0'
    ... 
}
```
