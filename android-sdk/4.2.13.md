...
3.<a id='4.2.13-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## IndoorAtlas location provider<a id='4.2.13-ia-navigation'></a>
