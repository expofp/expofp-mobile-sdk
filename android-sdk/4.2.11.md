...
* [ExpoFP-GPS location provider](#4.2.11-efp-navigation)
...
## ExpoFP-GPS location provider<a id='4.2.11-efp-navigation'></a>
...
```java
dependencies {
    implementation 'com.expofp:gpsprovider:4.2.11'
    ... 
}
```
