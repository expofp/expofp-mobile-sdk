...
* [Setup](#4.1.5-setup)
* [Usage](#4.1.5-usage)
* [Offline mode](#4.1.5-offline)
* [Functions](#4.1.5-functions)
* [Events](#4.1.5-events)
...
```java
dependencies {
    implementation 'com.expofp:common:4.1.5'
    implementation 'com.expofp:fplan:4.1.5'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.1.5'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.1.5'
...
## Offline mode<a id='4.1.5-offline'></a>
...
## Functions<a id='4.1.5-functions'></a>
...
```java
dependencies {
    implementation 'com.expofp:gpsprovider:4.1.5'
    ... 
}
```
