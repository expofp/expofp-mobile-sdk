...
* [Setup](#4.5.3-setup)
* [Usage](#4.5.3-usage)
* [Offline mode](#4.5.3-offline)
* [Settings сlass](#4.5.3-settings-class)
* [Functions](#4.5.3-functions)
* [Events](#4.5.3-events)
* [Festivals](#4.5.3-fest)
...
Added the ability to pass a null value to the 'selectCategory' method.

## Setup<a id='4.5.3-setup'></a>
...
```java
dependencies {
    implementation 'com.expofp:common:4.5.3'
    implementation 'com.expofp:fplan:4.5.3'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.5.3'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.5.3'
...
## Offline mode<a id='4.5.3-offline'></a>
...
3.<a id='4.5.3-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## Settings сlass<a id='4.5.3-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.5.3-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.5.3-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.5.3-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.5.3-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.5.3-global-location-provider) chapter.
...
## Functions<a id='4.5.3-functions'></a>
...
#### Festival events <a id='4.5.3-fest-events'></a>
