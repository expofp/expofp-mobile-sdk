...
## 4.5.0 version<a id='4.5.0'></a>

## Table of Contents
* [What's New](#4.5.0-what-is-new)
* [Setup](#4.5.0-setup)
* [Usage](#4.5.0-usage)
* [Offline mode](#4.5.0-offline)
* [Settings сlass](#4.5.0-settings-class)
* [Functions](#4.5.0-functions)
* [Events](#4.5.0-events)
* [Festivals](#4.5.0-fest)
* [Navigation](#4.5.0-navigation)
* [GlobalLocationProvider](#4.5.0-global-location-provider)
* [CrowdConnected location provider](#4.5.0-cc-navigation)
* [IndoorAtlas location provider](#4.5.0-ia-navigation)

## What's New in ExpoFP Fplan version 4.5.0<a id='4.5.0-what-is-new'></a>

CrowdConnected packages have been updated to version 1.5.2. The target Android Api(targetSdk) version has been changed to 34.

## Setup<a id='4.5.0-setup'></a>
...
```java
dependencies {
    implementation 'com.expofp:common:4.5.0'
    implementation 'com.expofp:fplan:4.5.0'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.5.0'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.5.0'
...
## Offline mode<a id='4.5.0-offline'></a>
...
3.<a id='4.5.0-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## Settings сlass<a id='4.5.0-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.5.0-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.5.0-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.5.0-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.5.0-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.5.0-global-location-provider) chapter.
...
## Functions<a id='4.5.0-functions'></a>
...
#### Festival events <a id='4.5.0-fest-events'></a>
...
## Navigation<a id='4.5.0-navigation'></a>
...
#### GlobalLocationProvider<a id='4.5.0-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.5.0-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.5.0-global-location-provider).
...
## IndoorAtlas location provider<a id='4.5.0-ia-navigation'></a>
