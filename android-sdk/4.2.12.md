...
## 4.2.12 version<a id='4.2.12'></a>

## Table of Contents
* [What's New](#4.2.12-what-is-new)
* [Setup](#4.2.12-setup)
* [Usage](#4.2.12-usage)
* [Offline mode](#4.2.12-offline)
* [Settings сlass](#4.2.12-settings-class)
* [Functions](#4.2.12-functions)
* [Events](#4.2.12-events)
* [Festivals](#4.2.12-fest)
* [Navigation](#4.2.12-navigation)
* [GlobalLocationProvider](#4.2.12-global-location-provider)
* [CrowdConnected location provider](#4.2.12-cc-navigation)
* [IndoorAtlas location provider](#4.2.12-ia-navigation)

## What's New in ExpoFP Fplan version 4.2.12<a id='4.2.12-what-is-new'></a>

CrowdConnected packages have been updated to version 1.3.6.

## Setup<a id='4.2.12-setup'></a>
...
## Offline mode<a id='4.2.12-offline'></a>
...
3.<a id='4.2.12-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## Settings сlass<a id='4.2.12-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.2.12-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.2.12-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.2.12-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.2.12-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.2.12-global-location-provider) chapter.
...
## Functions<a id='4.2.12-functions'></a>
...
#### Festival events <a id='4.2.12-fest-events'></a>
...
## Navigation<a id='4.2.12-navigation'></a>
...
#### GlobalLocationProvider<a id='4.2.12-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.2.12-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.2.12-global-location-provider).
...
## IndoorAtlas location provider<a id='4.2.12-ia-navigation'></a>
