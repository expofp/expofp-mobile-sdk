...
* [Setup](#4.2.4-setup)
* [Usage](#4.2.4-usage)
* [Offline mode](#4.2.4-offline)
* [Settings сlass](#4.2.4-settings-class)
* [Functions](#4.2.4-functions)
* [Events](#4.2.4-events)
* [Festivals](#4.2.4-fest)
...
## Offline mode<a id='4.2.4-offline'></a>
...
3.<a id='4.2.4-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## Settings сlass<a id='4.2.4-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.2.4-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.2.4-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.2.4-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.2.4-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.2.4-global-location-provider) chapter.
...
## Functions<a id='4.2.4-functions'></a>
...
#### Festival events <a id='4.2.4-fest-events'></a>
...
```java
dependencies {
    implementation 'com.expofp:gpsprovider:4.2.4'
    ... 
}
```
