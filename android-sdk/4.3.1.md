...
* [Setup](#4.3.1-setup)
* [Usage](#4.3.1-usage)
* [Offline mode](#4.3.1-offline)
* [Settings сlass](#4.3.1-settings-class)
* [Functions](#4.3.1-functions)
* [Events](#4.3.1-events)
* [Festivals](#4.3.1-fest)
...
```java
dependencies {
    implementation 'com.expofp:common:4.3.1'
    implementation 'com.expofp:fplan:4.3.1'
...
Settings settings = new Settings()
                ...
                .withEventsListener(new FplanEventsListener() {
                    ...
                    @Override
                    public void onBoothClick(@Nullable String id, @Nullable String name, @Nullable String externalId) {
                    }
...
## Offline mode<a id='4.3.1-offline'></a>
...
3.<a id='4.3.1-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## Settings сlass<a id='4.3.1-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.3.1-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.3.1-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.3.1-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.3.1-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.3.1-global-location-provider) chapter.
...
## Functions<a id='4.3.1-functions'></a>
...
##### com.expofp.fplan.models.Booth properties:
...
##### com.expofp.fplan.models.RouteBooth properties:
...
#### Festival events <a id='4.3.1-fest-events'></a>
