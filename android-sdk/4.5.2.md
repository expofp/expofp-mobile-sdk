...
* [Setup](#4.5.2-setup)
* [Usage](#4.5.2-usage)
* [Offline mode](#4.5.2-offline)
* [Settings сlass](#4.5.2-settings-class)
* [Functions](#4.5.2-functions)
* [Events](#4.5.2-events)
* [Festivals](#4.5.2-fest)
...
Functions selectCategory, getVisibility, setVisibility, findLocation, zoomIn, zoomOut, switchView, fitBounds was added.
The ability to specify a point(SelectRoutePoint class) as a starting point or destination point in the 'selectRoute()' function has been added.

## Setup<a id='4.5.2-setup'></a>
...
```java
dependencies {
    implementation 'com.expofp:common:4.5.2'
    implementation 'com.expofp:fplan:4.5.2'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.5.2'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.5.2'
...
## Offline mode<a id='4.5.2-offline'></a>
...
3.<a id='4.5.2-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
## Settings сlass<a id='4.5.2-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.5.2-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.5.2-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.5.2-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.5.2-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.5.2-global-location-provider) chapter.
...
## Functions<a id='4.5.2-functions'></a>
...
#### Festival events <a id='4.5.2-fest-events'></a>
...
## Navigation<a id='4.5.2-navigation'></a>
