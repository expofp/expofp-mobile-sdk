...
## 4.0.0 version<a id='4.0.0'></a>

## Table of Contents
* [What's New](#4.0.0-what-is-new)
* [Setup](#4.0.0-setup)
* [Usage](#4.0.0-usage)
* [Functions](#4.0.0-functions)
* [Events](#4.0.0-events)
* [Navigation](#4.0.0-navigation)
* [CrowdConnected location provider](#4.0.0-cc-navigation)
* [IndoorAtlas location provider](#4.0.0-ia-navigation)

### What's New in ExpoFP Fplan version 4.0.0<a id='4.0.0-what-is-new'></a>

The 'onDetails' and 'onExhibitorCustomButtonClick' events have been added.

### Setup<a id='4.0.0-setup'></a>
...
```java
dependencies {
    implementation 'com.expofp:common:4.0.0'
    implementation 'com.expofp:fplan:4.0.0'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.0.0'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.0.0'
    
    ... 
}
```

### Usage<a id='4.0.0-usage'></a>
...
### Functions<a id='4.0.0-functions'></a>
...
### Navigation<a id='4.0.0-navigation'></a>
...
### CrowdConnected location provider<a id='4.0.0-cc-navigation'></a>
...
### IndoorAtlas location provider<a id='4.0.0-ia-navigation'></a>
