...
## 4.10.4 version<a id='4.10.4'></a>

## Table of Contents
* [What's New](#4.10.4-what-is-new)
* [Recommendations for use](#4.10.4-recommendations)
* [Setup](#4.10.4-setup)
* [Usage](#4.10.4-usage)
* [Offline mode](#4.10.4-offline)
* [Shared components](#4.10.4-shared-components)
* [Settings сlass](#4.10.4-settings-class)
* [Functions](#4.10.4-functions)
* [Events](#4.10.4-events)
* [Festivals](#4.10.4-fest)
* [Navigation](#4.10.4-navigation)
* [GlobalLocationProvider](#4.10.4-global-location-provider)
* [CrowdConnected location provider](#4.10.4-cc-navigation)
* [IndoorAtlas location provider](#4.10.4-ia-navigation)

## What's New in ExpoFP Fplan version 4.10.4<a id='4.10.4-what-is-new'></a>

CrowdConnected SDK has been updated to version 2.0.3 and a bug in the ExpoFpFplan package has been fixed.

## Recommendations for use<a id='4.10.4-recommendations'></a>

It is recommended to use the [SharedFplanView](#4.10.4-shared-components) control instead of the usual FplanView. 
...
```java
dependencies {
    implementation 'com.expofp:common:4.10.4'
    implementation 'com.expofp:fplan:4.10.4'
    
    //If you want to use navigation from CrowdConnected, add a link to the package
    //implementation 'com.expofp:crowdconnected:4.10.4'
    
    //If you want to use navigation from IndoorAtlas, add a link to the package
    //implementation 'com.expofp:indooratlas:4.10.4'
    
    ... 
}
```

## Usage<a id='4.10.4-usage'></a>
...
## Offline mode<a id='4.10.4-offline'></a>
...
## Shared compenents<a id='4.10.4-shared-components'></a>
...
## Settings сlass<a id='4.10.4-settings-class'></a>
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.10.4-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.10.4-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.10.4-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.10.4-global-location-provider) chapter.
...
## Functions<a id='4.10.4-functions'></a>
...
#### Festival events <a id='4.10.4-fest-events'></a>
...
## Navigation<a id='4.10.4-navigation'></a>
...
#### GlobalLocationProvider<a id='4.10.4-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.10.4-cc-navigation'></a>
...
```java
dependencies {
    implementation 'com.expofp:crowdconnectedbackground:4.10.4'
    ... 
}
```
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.10.4-global-location-provider).
...
## IndoorAtlas location provider<a id='4.10.4-ia-navigation'></a>
