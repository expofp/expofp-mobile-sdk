...
3.<a id='4.2.14-offline-init'></a> In the init() method, it is possible to specify the path to the offline archive with the plan. 
...
##### com.expofp.fplan.RouteBooth properties:
