...
## 4.9.6 version<a id='4.9.6'></a>

## Table of Contents
* [What's New](#4.9.6-what-is-new)
* [Recommendations for use](#4.9.6-recommendations)
* [Setup](#4.9.6-setup)
* [Usage](#4.9.6-usage)
* [Offline mode](#4.9.6-offline)
* [Settings сlass](#4.9.6-settings-class)
* [Functions](#4.9.6-functions)
* [Events](#4.9.6-events)
* [Festivals](#4.9.6-fest)
* [Navigation](#4.9.6-navigation)
* [GlobalLocationProvider](#4.9.6-global-location-provider)
* [CrowdConnected location provider](#4.9.6-cc-navigation)
* [IndoorAtlas location provider](#4.9.6-ia-navigation)

## What's New in ExpoFP Fplan version 4.9.6<a id='4.9.6-what-is-new'></a>

Bug fixes and performance improvements.

## Recommendations for use<a id='4.9.6-recommendations'></a>
...
## Offline mode<a id='4.9.6-offline'></a>
...
## Settings сlass<a id='4.9.6-settings-class'></a>
...
- loadingTimeout(int, optional) - timeout for loading the plan, after this time has elapsed, 
  FplanView will try to load the [offline version](#4.9.6-offline-init) or give an error. 
...
Specifies a subscriber for plan events. Events are described in the [Events](#4.9.6-events) chapter.
...
Specifies a subscriber for Festival events. Festival events are described in the [Festival events](#4.9.6-fest-events) chapter.
...
Specifies the location provider. The location provider is described in the [Navigation](#4.9.6-navigation) chapter.
...
Specifies that the GlobalLocationProvider should be used. The GlobalLocationProvider is described in the [GlobalLocationProvider](#4.9.6-global-location-provider) chapter.
...
## Functions<a id='4.9.6-functions'></a>
...
#### Festival events <a id='4.9.6-fest-events'></a>
...
## Navigation<a id='4.9.6-navigation'></a>
...
#### GlobalLocationProvider<a id='4.9.6-global-location-provider'></a>
...
## CrowdConnected location provider<a id='4.9.6-cc-navigation'></a>
...
When using CrowdConnectedProvider, it is recommended to run it in the background (when the program starts) using the [GlobalLocationProvider](#4.9.6-global-location-provider).
...
## IndoorAtlas location provider<a id='4.9.6-ia-navigation'></a>
